            ...
            <div className='bmcfooterMob__root' style={{
                ...
                <div className='bmcfooterMob__row'>
                    <div className='bmcfooterMob__row__left'>
                        <img alt='nav'src={`${endpoint}/images/Logo (1).png`} className='bmcfooterMob__row__img' />
                        <br></br>
