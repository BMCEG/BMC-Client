...
export default class NewPosting extends Component {
  ...
  handleCreatePosting = async () => {
    ...
    await axios
      .post(`${endpoint}/jobs/create`, newPosting)
      .then((res) => {
          ...
          <div className="trainer-create-form">
            <div className="trainer-create-form-left">
              ...
              <TextField
                ...
                value={this.state.jobDepartment}
                onChange={this.handleInputChange}
                fullWidth
              />
              <br></br>
              ...
              <div className="career-create-form-xp">
                <TextField
                  className="career-create-form-xp-input"
                  variant="outlined"
                  name="jobMinXP"
                  type="number"
                  label="Minimum Experience"
                  value={this.state.jobMinXP}
                  onChange={this.handleInputChange}
                />
                <TextField
                  className="career-create-form-xp-input"
              ...
              <div className="career-create-form-xp">
                ...
                <TextField
                  ...
                  value={this.state.jobMaxSalary}
                  onChange={this.handleInputChange}
                />
              </div>
              <div className="trainer-btn-base">
                <Button variant="danger" onClick={this.handleCreatePosting}>
                  Add Trainer
                </Button>
              </div>
            </div>
            <div className="trainer-create-form-right">
              ...
              <Button
                variant="secondary"
                onClick={this.handleAddQualifications}
              >
              ...
              <Button
                variant="secondary"
                onClick={this.handleAddResponsibilities}
              >
