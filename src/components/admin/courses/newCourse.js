...
export default class NewCourse extends Component {
  ...
  async handleCreateCourse() {
    ...
    await axios.post(`${endpoint}/courses/create`, course).then((res) => {
          ...
          <div className="course-create-form">
            <div className="course-create-form-left">
              ...
              <TextField
                ...
                value={this.state.courseMethodology}
                onChange={this.handleInputChange}
            ...
            <div className="course-create-form-center">
              ...
              <div className="course-create-form-schedules">
                <Button
                  className="course-create-form-btn"
                  variant="danger"
                ...
                >
                  <div
                    className="course-create-modal-body"
                    style={{
                      backgroundImage: `url(${endpoint}/images/bg-founder.png)`,
                      backgroundSize: 'cover',
                    }}
                  >
                    ...
                    <div className="course-create-modal-body-right">
                      ...
                      <div className="course-create-weekdate-btn-base">
                        <Button
                          variant="danger"
                          className="course-create-weekdate-btn"
                          onClick={this.handleAddWeekdate}
                        >
                          Add Weekdate
                        </Button>
                      </div>
                        ...
                        {this.state.weekdates.map((weekdate) => (
                          <>
                            <div className="course-create-weekdate-base">
                              <h3>
                                {weekdate.weekday} ({weekdate.duration} Hours)
                              </h3>
