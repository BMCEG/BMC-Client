...
export default class NewPartner extends Component {
  ...
  handleCreatePartner = async () => {
    ...
    await axios
      .post(`${endpoint}/partners/create`, newPosting)
      .then((res) => {
          ...
          <div className="trainer-create-form">
            <div className="trainer-create-form-left">
              ...
              <TextField
                ...
                value={this.state.partnerDescription}
                onChange={this.handleInputChange}
                fullWidth
              />
              <br></br>
            ...
            <div className="trainer-create-form-right">
              ...
              <hr></hr>
              <br></br>
              <Button variant="secondary" onClick={this.handleCreatePartner}>
                Create Partner
              </Button>
            </div>
            <br></br>
