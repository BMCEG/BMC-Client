...
export default class NewPartner extends Component {
    ...
    handleCreateAdmin = async () => {
        ...
        await axios.post(`${endpoint}/admins/register`, newAdmin)
            .then((res) => {
                ...
                <div className='trainer-create-base' style={{ backgroundImage: `url(${endpoint}/imagesbg-founder.png)`, backgroundSize: 'cover' }}>
                    <div className='trainer-create-form'>
                        ...
                        <div className='trainer-create-form-right'>
                            <TextField variant='outlined' name='email' label='E-Mail' value={this.state.email} onChange={this.handleInputChange} fullWidth />
                            <br></br>
                            <br></br>
                            <TextField variant='outlined' type='password' name='password' label='Password' value={this.state.password} onChange={this.handleInputChange} fullWidth />
                            <br></br>
                            <br></br>
                        </div>
                        <br></br>
                    ...
                    <Button variant='danger' className='users-create-btn' onClick={this.handleCreateAdmin}>Create Admin</Button>
                    </div>
                </div>
