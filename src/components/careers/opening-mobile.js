...
export default class OpeningMob extends Component {
    ...
    render() {
        return (
            // <div className="career-opening-card" style={{ backgroundImage: `url(${endpoint}/images/bg-founder.png)`, backgroundSize: 'cover' }}>
            <Accordion className="career-opening-card-mobile" expanded={this.state.isExpanded} onChange={() => this.handleChange('panel')} style={{ backgroundImage: `url(${endpoint}/images/bg-founder.png)`, backgroundSize: 'cover' }}>
                <AccordionSummary
