  ...
  render() {
    return (
      <div className="footer-top">
        <img
          className="footer-top__left"
          src={`${endpoint}/images/Shape-01.png`}
        />
          ...
          <MediaQuery maxWidth={900}>
            <div className="footer-top__mobile">
              <div className="footer-top__mobile__left">
                <Button
                  variant="link"
                  className="footer__top__social__btn"
                  href="tel:01008224224"
                >
                  <img
                    src={`${endpoint}/images/Icons 2-03.png`}
                    className="footer-top__center__social__btn__img"
                  />
                </Button>
              </div>
              ...
              <div className="footer-top__mobile__right">
                <Button
                  ...
                  variant="link"
                  href="/consultations"
                  className="footer-top__content__mob footer-top__content__right__btn--size"
                >
                  Request Consultancy
                </Button>
              </div>
            ...
            <div className="footer-top__content">
              <div className="footer-top__content__left">
                <div className="footer-top__content__left__row">
                  ...
                  >
                    <img
                      src={`${endpoint}/images/Icons 2-01.png`}
                      className="footer-top__center__social__btn__img"
                    />
                  </Button>
                  <Button
                  ...
                  >
                    <img
                      src={`${endpoint}/images/Icons 2-02.png`}
                      className="footer-top__center__social__btn__img"
                    />
                  </Button>
                  <Button
              ...
              <div className="footer-top__content__right">
                <Button
                  ...
                  variant="link"
                  href="/consultations"
                  className="footer-top__content__right__btn footer-top__content__right__btn--size"
                >
                  Request Consultancy
                </Button>
              </div>
        ...
        <img
          className="footer-top__right"
          src={`${endpoint}/images/Shape-02.png`}
        />
      </div>
    );
  }
