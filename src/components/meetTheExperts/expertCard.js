      ...
      <Paper className="expert-paper">
        ...
        <div className="expert-details">
          ...
          <div className="expert-paper-links">
            <Button
              className="expert-paper-link-btn"
              onClick={() => this.handleClick(this.props.expert.links.twitter)}
            >
              <FontAwesomeIcon icon={faTwitter} size="2x" />
            </Button>
            <Button
              className="expert-paper-link-btn"
              onClick={() => this.handleClick(this.props.expert.links.facebook)}
            >
            ...
            <Button
              className="expert-paper-link-btn"
              onClick={() =>
                this.handleClick(this.props.expert.links.instagram)
              }
            >
            ...
            <Button
              className="expert-paper-link-btn"
              onClick={() => this.handleClick(this.props.expert.links.linkedIn)}
            >
