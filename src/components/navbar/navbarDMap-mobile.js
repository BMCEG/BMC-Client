          ...
          <div className="title" style={{ marginLeft: 'auto' }}>
            <Dropdown>
              ...
              <Dropdown.Menu align={{ lg: 'left' }}>
                ...
                <hr></hr>
                <Dropdown.Item>
                  <h5 className="bukra-bold">Services:</h5>
                </Dropdown.Item>
                ...
                <br></br>
                <Dropdown.Item href="/ewings/gallery">
                  <h5 className="bukra-bold">Gallery</h5>
                </Dropdown.Item>
                ...
                <hr></hr>
                <Dropdown.Item href="/">
                  <h5 className="bukra-bold">BMC</h5>
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </div>
