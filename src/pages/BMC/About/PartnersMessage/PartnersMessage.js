      ...
      <div className="partners__root">
        ...
        <div className="strategic-planning__banner">
          <img
            ...
            src={`${endpoint}/images/Slide-1.png`}
            alt="Marketing Mgmt"
          />
        </div>
        <br></br>
          ...
          <div className="finance-accounting__body--right">
            <div>
              ...
              <Typography className="finance-accounting__body--text">
                Our passion is to add value to others, Impact is our main core
                value, Impact is a key part of our business. we are and will be
                always- making an impact on someone’s life every single day.
              </Typography>
            </div>
          </div>
        </div>
        ...
        <div className="strategic-planning__img--base">
          ...
          <img
            ...
            src={`${endpoint}/images/Slide-2.png`}
            alt="Marketing Mgmt"
          />
        ...
        <div className="partners__body">
          ...
          <Typography className="partners__body__text partners__body__text--size">
            In a rapidly changing environment and dynamic markets. All
            businesses face many challenges that need a practical application to
            adopt and remain dynamically changing as the economy and market
            dictate.
            <br></br>
            We have a team who adapt and change according to what we face in our
            business process.
            <br></br>
        ...
        <div className="strategic-planning__img--base">
          ...
          <img
            className="strategic-planning__img"
            src={`${endpoint}/images/Slide-3.png`}
            alt="Marketing Mgmt"
          />
          <div className="strategic-planning__body__img__border-right"></div>
        </div>
        ...
        <div className="partners__body">
          ...
          <Typography className="partners__body__text partners__body__text--size">
            Our employees are our main assets, we make sure to provide them with
            sense of security, educational development, public awareness, we
            also provide them all the factors of success that builds them to be
            the future leaders
          </Typography>
        </div>
        ...
        <div className="strategic-planning__img--base">
          ...
          <img
            className="strategic-planning__img"
            src={`${endpoint}/images/Slide-4.png`}
            alt="Marketing Mgmt"
          />
          <div className="strategic-planning__body__img__border-right"></div>
        </div>
        ...
        <div className="partners__body">
          ...
          <Typography className="partners__body__text partners__body__text--size">
            BMC will be passionately tailoring and giving you the best service
            to help your business achieve optimal results and maximum
            development. <br></br>
            We believe that money is a result, not an objective, so the value
            you’ll receive will always exceed our fees and your expectations.{' '}
            <br></br>
          </Typography>
        </div>
        <br></br>
