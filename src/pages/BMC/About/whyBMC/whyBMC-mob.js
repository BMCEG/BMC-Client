...
export default class whyBMCMob extends Component {
  render() {
    return (
      <div className="whybmc__root">
        ...
        <div className="strategic-planning__banner">
          <img
            ...
            src={`${endpoint}/images/whybmc-h.png`}
            alt="Marketing Mgmt"
          />
        </div>
        <br></br>
        ...
        <div className="whybmc__service--row--mob">
          <img
            src={`${endpoint}/images/whybmc-1.png`}
            alt="service"
            className="whybmc__service--img--mob"
          />
          <div className="whybmc__service--info--mob">
            ...
            <Typography className="whybmc__service--body whybmc__body--text">
              ...
              many different challenges and issues, now we can provide accurate
              perspectives and solutions based on academic and practical
              background.
            </Typography>
          </div>
        </div>
        ...
        <div className="whybmc__service--row--mob">
          <img
            src={`${endpoint}/images/whybmc-2.png`}
            alt="service"
            className="whybmc__service--img--mob"
          />
          <div className="whybmc__service--info--mob">
            ...
            <br></br>
            <Typography className="whybmc__service--body whybmc__body--text">
              The main reason that companies hire us is to gain full access to a
              specialized skill set that might not exist in house. You get
        ...
        <div className="whybmc__service--row--mob">
          <img
            src={`${endpoint}/images/whybmc-3.png`}
            alt="service"
            className="whybmc__service--img--mob"
          />
          <div className="whybmc__service--info--mob">
        ...
        <div className="whybmc__service--row--mob">
          <img
            src={`${endpoint}/images/whybmc-4.png`}
            alt="service"
            className="whybmc__service--img--mob"
          />
          <div className="whybmc__service--info--mob">
        ...
        <div className="whybmc__service--row--mob">
          <img
            src={`${endpoint}/images/whybmc-5.png`}
            alt="service"
            className="whybmc__service--img--mob"
          />
          <div className="whybmc__service--info--mob">
            ...
            <br></br>
            <Typography className="whybmc__service--body whybmc__body--text">
              We provide you services with a safe zone where you can apply a new
              decision or take necessary actions for your business issue. BMC
              provides you with back-up plans and confirmation for your business
        ...
        <div className="whybmc__service--row--mob">
          <img
            src={`${endpoint}/images/whybmc-6.png`}
            alt="service"
            className="whybmc__service--img--mob"
          />
          <div className="whybmc__service--info--mob">
            ...
            <Typography className="whybmc__service--body whybmc__body--text">
              ...
              are considered as an extra horsepower for their business and that
              is what keeps us going in expanding our business.
            </Typography>
          </div>
        </div>
        <br></br>
