...
export default class CareersJoin extends Component {
  ...
  async handleSubmitApplication() {
    ...
    await axios
      .post(`${endpoint}/jobsApplications/join`, newListing)
      .then((res) => {
        ...
        <div className="careers__join__heading">
          <p className="strategic-planning__heading strategic-planning__body--text--card--heading">
            ...
            <span className="strategic-planning__body--text strategic-planning__body--text--card">
              ...
              Nothing we do is more Important than developing people and hiring
              good talents.
              <br></br>
              <br></br>
              Tell us more about your passion, academic background, and area of
              experience.
            </span>
          </p>
        </div>
        ...
        <div className="careers__join__form">
          ...
          <div className="contact-form-body-names">
            <TextField
              fullWidth
              name="applicationAge"
              value={this.state.applicationAge}
              label="Age"
              variant="outlined"
              className="careers__join__form__input"
              onChange={this.handleInputChange}
            />
            <div style={{ width: '2%' }} />
            <TextField
        ...
        <div className="careers__join__form__speciality">
          <form encType="multipart/form-data">
            <label
              ...
              className="courses__join__attach__btn"
            >
              Attach Resume
            </label>
