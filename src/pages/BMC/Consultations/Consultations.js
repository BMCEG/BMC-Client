      ...
      <div className="consultations__root">
        ...
        <div className="strategic-planning__banner">
          <img
            ...
            src={`${endpoint}/images/consultations.h.png`}
            alt="Marketing Mgmt"
          />
        </div>
        <br></br>
            ...
            <div>
              <p className="strategic-planning__heading strategic-planning__body--text--card--heading">
                ...
                <span className="strategic-planning__body--text strategic-planning__body--text--card">
                  more about your business and We will offer you a scheduled
                  one-hour free consultation meeting after receiving your
                  answers asap.
                </span>
              </p>
            </div>
        ...
        <div className="consultations__body">
          ...
          <div className="consultations__body__form">
            <TextField
              value={this.state.consultancyBusinessType}
              name="consultancyBusinessType"
            ...
            <div className="consultations__body__form__row">
              <TextField
                value={this.state.consultancyBusinessWebsite}
                name="consultancyBusinessWebsite"
                label="Website"
                variant="outlined"
                className="bmchome__contact__form__input"
                onChange={this.handleInputChange}
              ...
              <TextField
                value={this.state.consultancyBusinessFacebook}
                name="consultancyBusinessFacebook"
                label="Facebook"
                variant="outlined"
                className="bmchome__contact__form__input"
                onChange={this.handleInputChange}
              ...
              <div className="consultations__body__form__divider" />
              <TextField
                value={this.state.consultancyBusinessLinkedIn}
                name="consultancyBusinessLinkedIn"
                label="LinkedIn"
                variant="outlined"
                className="bmchome__contact__form__input"
                onChange={this.handleInputChange}
            ...
            <div className="consultations__body__form__row">
              <TextField
                value={this.state.consultancyBusinessInstagram}
                name="consultancyBusinessInstagram"
                label="Instagram"
                variant="outlined"
                className="bmchome__contact__form__input"
                onChange={this.handleInputChange}
              ...
              <div className="consultations__body__form__divider" />
              <TextField
                value={this.state.consultancyBusinessTwitter}
                name="consultancyBusinessTwitter"
                label="Twitter"
                variant="outlined"
                className="bmchome__contact__form__input"
                onChange={this.handleInputChange}
              ...
              <div className="consultations__body__form__divider" />
              <TextField
                value={this.state.consultancyBusinessYouTube}
                name="consultancyBusinessYouTube"
                label="YouTube"
                variant="outlined"
                className="bmchome__contact__form__input"
                onChange={this.handleInputChange}
          ...
          <div className="consultations__body__form">
            <TextField
              value={this.state.consultancyBusinessGoals}
              name="consultancyBusinessGoals"
              label="What are your objectives and goals"
              rows={10}
              multiline
              variant="outlined"
              className="bmchome__contact__form__input"
          ...
          <div className="consultations__body__form">
            <TextField
              value={this.state.consultancyBusinessChallenges}
              name="consultancyBusinessChallenges"
              label="What are the barriers facing you to grow, describe your problems."
              rows={10}
              multiline
              variant="outlined"
              className="bmchome__contact__form__input"
          ...
          <div className="courses__join__submit__width">
            <Button
              className="courses__join__submit--btn"
