            ...
            <div className='contact__root'>
                ...
                <div className='contact__root__contact--mob'>
                    <div className='bmchome__contact__right--mob'>
                        <iframe title='8' className='bmchome__contact__map' src="https://maps.google.com/maps?q=30.015124,%2031.427728&t=&z=17&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0"></iframe>
                    </div>
                    <br></br>
