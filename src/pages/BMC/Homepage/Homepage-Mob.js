      ...
      <div className="bmchome-root">
        <div className="bmchome__banner">
          <Carousel fade className="bmchome__banner__carousel" controls={false}>
            <Carousel.Item>
              <div
                className="bmchome__banner__carousel--item"
                style={{
                  backgroundImage: `url(${endpoint}/images/Homepage-Header-1.png)`,
            ...
            <Carousel.Item>
              <div
                className="bmchome__banner__carousel--item"
                style={{
                  backgroundImage: `url(${endpoint}/images/Homepage-Header-2.png)`,
                  backgroundSize: 'cover',
                  backgroundRepeat: 'no-repeat',
                  backgroundPosition: 'center',
                }}
            ...
            <Carousel.Item>
              <div
                className="bmchome__banner__carousel--item"
                style={{
                  backgroundImage: `url(${endpoint}/images/Homepage-Header-3.png)`,
                  backgroundSize: 'cover',
                  backgroundRepeat: 'no-repeat',
                  backgroundPosition: 'center',
                }}
          ...
          <div className="strategic-planning__body_canvas">
            <p className="strategic-planning__heading strategic-planning__body--text--card--heading">
              ...
              <span className="strategic-planning__body--text strategic-planning__body--text--card">
                in such broad business tools as Strategic audit, Feasibility
                studies, research and analysis, Business strategies - Internal
                business processes Business development, book keeping, financial
                audits, Business Manuals, Digital transformation, training
                courses, among other custom-tailored services.
              </span>
            </p>
          </div>
        ...
        <div className="bmchome__service__row">
          <img
            className="bmchome__service__row__img"
            src={`${endpoint}/images/Strategic-Plan.png`}
            alt="service"
          />
          <div className="bmchome__service__row__details">
            ...
            <Typography className="bmchome__service__row__details--text bmchome__services__text--size">
              BMC has the aim to provide professional counsel and assistance in
              the analysis,.....
            </Typography>
          </div>
        </div>
        <div className="bmchome__service__below">
          <Button
            className="bmchome__service__row__btn"
        ...
        <div className="bmchome__service__row">
          <img
            className="bmchome__service__row__img"
            src={`${endpoint}/images/Marketing-Management.png`}
            alt="service"
          />
          <div className="bmchome__service__row__details">
            <Typography className="bmchome__service__row__details--header">
            ...
            <Typography className="bmchome__service__row__details--text bmchome__services__text--size">
              We act as your marketing arm department, we have the right blend
              of strategists and planners,...
            </Typography>
          </div>
        </div>
        <div className="bmchome__service__below">
        ...
        <div className="bmchome__service__row">
          <img
            className="bmchome__service__row__img"
            src={`${endpoint}/images/HR-Management.png`}
            alt="service"
          />
          <div className="bmchome__service__row__details">
            <Typography className="bmchome__service__row__details--header">
            ...
            <Typography className="bmchome__service__row__details--text bmchome__services__text--size">
              We provide Human Resources service in support of our client’s
              vision,.....
            </Typography>
          </div>
        </div>
        ...
        <div className="bmchome__service__row">
          <img
            className="bmchome__service__row__img"
            src={`${endpoint}/images/Finance-&-Accounting.png`}
            alt="service"
          />
          <div className="bmchome__service__row__details">
            <Typography className="bmchome__service__row__details--header">
            ...
            <Typography className="bmchome__service__row__details--text bmchome__services__text--size">
              We have the aim to provide a full range of comprehensive high
        ...
        <div className="bmchome__service__row">
          <img
            className="bmchome__service__row__img"
            src={`${endpoint}/images/BMC-Tool-Box.png`}
            alt="service"
          />
          <div className="bmchome__service__row__details">
            <Typography className="bmchome__service__row__details--header">
            ...
            <Typography className="bmchome__service__row__details--text bmchome__services__text--size">
              We are often engaged to provide Custom-tailored solutions,We can
              help formulate the specific....
            </Typography>
          </div>
        </div>
        <div className="bmchome__service__below">
        ...
        <div className="partners__divider" />
        <br></br>
        <div className="bmchome__contact--mob">
            ...
            <div className="bmchome__contact__form">
              <div className="contact-form-body-right">
                <div className="contact-form-body-names">
                  <TextField
                    ...
                    label="First Name"
                    variant="outlined"
                    className="bmchome__contact__form__input"
              ...
              <div className="contact-form-btn-base">
                <Button
                  ...
                  className="bmchome__contact__form__btn bukra-regular"
                >
                  Send Message
                </Button>
              </div>
