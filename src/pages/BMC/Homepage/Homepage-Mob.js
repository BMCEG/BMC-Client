            ...
            <div className='bmchome-root'>
                ...
                <div className='bmchome__banner'>
                    ...
                    <Carousel fade className="bmchome__banner__carousel" controls={false}>
                        ...
                        <Carousel.Item>
                            <div className='bmchome__banner__carousel--item' style={{ backgroundImage: `url(${endpoint}/Homepage-Header-2.png)`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
                                <Typography className='bmchome__banner__carousel--text bmchome__banner__carousel--text--size'>
                                    MARKETING
                                    <br></br>
                                    MASTERS
                        ...
                        <Carousel.Item>
                            <div className='bmchome__banner__carousel--item' style={{ backgroundImage: `url(${endpoint}/Homepage-Header-3.png)`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
                                <Typography className='bmchome__banner__carousel--text bmchome__banner__carousel--text--size'>
                                    EFFICIENCY IN
                                    <br></br>
                                    EVERY PATH
