    ...
    return (
      <div className="finance-accounting__root">
        ...
        <div className="finance-accounting__banner">
          <img
            className="finance-accounting__banner-img"
            src={`${endpoint}/images/FA-H.png`}
            alt="Marketing Mgmt"
          />
        </div>
        <br></br>
          ...
          <div className="finance-accounting__body--right">
            <div>
              <Typography className="finance-accounting__body--text">
                BMC’s Financial Management division has the aim to provide your
                company a full range of past and future comprehensive high
                quality services with a modern and practical approach in several
                fields.
              </Typography>
            </div>
          </div>
        ...
        <div className="finance-accounting__img--base">
          <div className="finance-accounting__body__img__border-left"></div>
