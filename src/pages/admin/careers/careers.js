                ...
                <div className='admin-careers-root' style={{ backgroundImage: `url(${endpoint}/bg-experts.png)`, backgroundSize: 'cover' }}>
                    <div className='admin-careers-controls' style={{ backgroundImage: `url(${endpoint}/bg-four.png)`, backgroundSize: 'cover' }}>
                        <div className='admin-careers-controls-btns'>
                            ...
                            <br></br>
                            <AdminBtn label={'View Job Postings'} icon={faChalkboardTeacher} onClick={() => this.handleBtnClick('JobPostings')} />
                            <br></br>
                            <AdminBtn label={'View Applications'} icon={faPlusCircle} onClick={() => this.handleBtnClick('JobApplications')} />
                            <br></br>
                        </div>
                    </div>
                    <div className='admin-careers-body'>
                        {this.state.context === 'JobApplications' ? 
                            <JobApplications />    : this.state.context === 'JobPostings' ?
