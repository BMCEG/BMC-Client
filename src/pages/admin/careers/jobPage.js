...
export default class Course extends Component {
  ...
  async handleDelete() {
    await axios
      .post(`${endpoint}/jobs/${this.state.postingID}/delete`)
      .then((res) => {
  ...
  async handleConfirm() {
    ...
    await axios
      .post(`${endpoint}/jobs/${this.state.posting._id}/edit`, editedPosting)
      .then((res) => {
                      ...
                      <div style={{ marginRight: '5%' }}>
                        <h4>
                          ...
                          <TextField
                            type="number"
                            onChange={this.handleInputChange}
                            value={this.state.editedJobMinSalary}
                            name="editedJobMinSalary"
                          />
                        </h4>
                      </div>
                      <div>
                        <h4>
                          ...
                          <TextField
                            type="number"
                            onChange={this.handleInputChange}
                            value={this.state.editedJobMaxSalary}
                            name="editedJobMaxSalary"
                          />
                        </h4>
                      </div>
                    </div>
