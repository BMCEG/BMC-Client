...
export default class Course extends Component {
  ...
  componentDidMount = async () => {
    await axios
      .get(`${endpoint}/courses/id/${this.state.courseID}`)
      .then((res) => {
        this.setState({
          course: res.data,
  ...
  async handleDelete() {
    await axios
      .post(`${endpoint}/courses/${this.state.course._id}/delete`, {
  ...
  async handleConfirm() {
    ...
    await axios
      .post(`${endpoint}/courses/${this.state.course._id}/edit`, editedCourse)
      .then((res) => {
                ...
                <Zoom in={this.state.isEditing}>
                  <div>
                    ...
                    <h4>
                      ...
                      <TextField
                        onChange={this.handleInputChange}
                        value={this.state.editedURLTitle}
                        name="editedURLTitle"
                      />
                    </h4>
                    <br></br>
              ...
              {this.state.isEditing ? (
                <>
                  ...
                  <Zoom in={this.state.isEditing}>
                    <TextField
                      onChange={this.handleInputChange}
                      value={this.state.editedOutline}
                      name="editedOutline"
                      variant="outlined"
                      fullWidth
                      multiline
              ...
              {this.state.isEditing ? (
                <>
                  ...
                  <Zoom in={this.state.isEditing}>
                    <TextField
                      onChange={this.handleInputChange}
                      value={this.state.editedMethodology}
                      name="editedMethodology"
                      variant="outlined"
                      fullWidth
                      multiline
                      rows={10}
          ...
          <div className="admin-course-controls">
            <div className="admin-course-controls-info">
              {this.state.isEditing ? (
                ...
                <h4>
                  Trainer: {this.state.trainer.firstName}{' '}
