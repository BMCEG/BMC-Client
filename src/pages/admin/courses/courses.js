        ...
        >
          <div className="admin-courses-controls">
            <div className="admin-courses-controls-btns">
              <AdminBtn
                ...
                icon={faUserGraduate}
                onClick={() => this.handleBtnClick('CoursesApplications')}
              />
              <hr></hr>
              <AdminBtn
                label={'Create New Course'}
                icon={faChalkboardTeacher}
                onClick={() => this.handleBtnClick('CourseCreate')}
              />
              <br></br>
              <AdminBtn
                label={'View Courses'}
                icon={faChalkboardTeacher}
                onClick={() => this.handleBtnClick('Courses')}
              />
              <hr></hr>
              <AdminBtn
                label={'Create New Trainer'}
                icon={faPlusCircle}
                onClick={() => this.handleBtnClick('TrainerCreate')}
              />
              <br></br>
              <AdminBtn
                label={'View Trainers'}
                icon={faPlusCircle}
                onClick={() => this.handleBtnClick('Trainers')}
              />
              <br></br>
            </div>
          </div>
          <div className="admin-courses-body">
            {this.state.context === 'CoursesApplications' ? (
              <CoursesApplications />
            ) : this.state.context === 'CourseCreate' ? (
              <CreateCourse />
            ) : this.state.context === 'Courses' ? (
              <Courses />
            ) : this.state.context === 'Trainers' ? (
              <Trainers />
            ) : (
              <CreateTrainer />
            )}
