        ...
        >
          <div className="admin-courses-controls">
            <div className="admin-courses-controls-btns">
              <AdminBtn
                ...
                onClick={() => this.handleBtnClick('PictureUpload')}
              />
              <hr></hr>
              <AdminBtn
                label={'View Media'}
                icon={faUserGraduate}
                onClick={() => this.handleBtnClick('Pictures')}
              />
              <hr></hr>
              <AdminBtn
                label={'View Albums'}
                icon={faChalkboardTeacher}
                onClick={() => this.handleBtnClick('Albums')}
              />
              <br></br>
              <AdminBtn
                label={'Create New Album'}
                icon={faPlusCircle}
                onClick={() => this.handleBtnClick('AlbumCreate')}
              />
              <br></br>
            </div>
          </div>
          <div className="admin-courses-body">
            {this.state.context === 'Albums' ? (
              <Albums />
            ) : this.state.context === 'Pictures' ? (
              <Pictures />
            ) : this.state.context === 'AlbumCreate' ? (
              <AlbumCreate />
            ) : (
              <PictureUpload />
            )}
