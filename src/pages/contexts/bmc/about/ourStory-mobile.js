    ...
    return (
      <div className="ourStory-root-mob">
        ...
        >
          ...
          <AccordionDetails>
            <Typography variant="h6" component="h6" className="bukra-regular ">
              Since inception, we have advised, planned and managed investments
              valued over 6.5 billion EGP specializing in real-estate
              development and construction and trading industries
            </Typography>
          </AccordionDetails>
        </Accordion>
        <br></br>
        ...
        >
          ...
          <AccordionDetails>
            <Typography variant="h6" component="h6" className="bukra-regular">
              More industries included in the manufacturing and agricultural
              sector ordering feasibility studies and setup for factories in
              cosmeceuticals, detergents, food, and packing
            </Typography>
          </AccordionDetails>
        </Accordion>
        <br></br>
        ...
        >
          ...
          <AccordionDetails>
            <Typography variant="h6" component="h6" className="bukra-regular">
              Widen our scope of services to include Financial advisory, serving
              new sectors like import & export, supporting startups and
              entrepreneurs.
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        >
          ...
          <AccordionDetails>
            <Typography variant="h6" component="h6" className="bukra-regular">
              ...
              marketing services, hiring digital experts, and blend of thinkers,
        ...
        >
          ...
          <AccordionDetails>
            <Typography variant="h6" component="h6" className="bukra-regular">
              Dealing with COVID 19 Pandemic with all our business clients to
              pass this critical period with tailored crisis management
        ...
        >
          ...
          <AccordionDetails>
            <Typography variant="h6" component="h6" className="bukra-regular">
              Widen our scope to include Taxation, more industries included in
              the Banking and telecom sectors, providing marketing advisory for
              Banks, financial firms, and telecommunication companies
            </Typography>
          </AccordionDetails>
        </Accordion>
        <br></br>
