...
export default function careerLanding() {
    return (
        <div className="career-landing-root" style={{ backgroundImage: `url(${endpoint}/bg-our-story.png)`, backgroundSize: 'cover' }}>
            {/* <div className='career-landing-title career-landing-margins'>
                <h1>CAREERS</h1>
            </div> */}
            <div className='career-landing-banner' style={{ backgroundImage: `url(${endpoint}/bg-founder.png)`, backgroundSize: 'cover' }}>
