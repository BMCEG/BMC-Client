...
export default class CareerListing extends Component {
    ...
    render() {
        return (
            <div className='career-listing-root' style={{ backgroundImage: `url(${endpoint}/images/bg-our-story.png)`, backgroundSize: 'cover' }}>
                {/* <div className='career-listing-title'>
                    <h1>CAREERS</h1>
                </div> */}
                <div className='career-listing-details bukra-bold'style={{ backgroundImage: `url(${endpoint}/images/bg-founder.png)`, backgroundSize: 'cover' }}>
