              ...
              <div className="banner-grid-mobile">
                <div className="banner-text-mobile">
                  <h6 className="bukra-regular">
                    We are experts in such broad business tools as Strategic
                    audit, Feasibility studies, research and analysis, Business
                    strategies - Internal business processes – Business
                    development, book keeping, financial audits, Business
                    Manuals, Digital transformation, training courses, among
              ...
              <Grid item xs={6}>
                <div className="home-service-mobile">
                  <div className="home-service-icon-base-mobile">
                    <img
                      alt="placeholder"
                      className="home-service-icon-mobile"
                  ...
                  <div className="home-service-text-mobile">
                    ...
                    <h6 className="bukra-regular">
                      BMC has the aim to provide professional counsel, and plans
                      along with the development of the implementation framework
                      that assure client’s long-term growth.
                    </h6>
                  </div>

                  <div style={{ textAlign: 'right', paddingTop: '20px' }}>
                    <Button variant="danger" href="/services/strategic">
                      Read More
                    </Button>
                  </div>
                </div>
                <div className="home-service-mobile">
                  ...
                  <div className="home-service-text-mobile">
                    ...
                    <h6 className="bukra-regular">
                      We provide Human Resources service promoting the concept
                      that employees are the most valuable resource and will be
                      treated as such.
                    </h6>
                  </div>

                  <div style={{ textAlign: 'right', paddingTop: '20px' }}>
                    <Button variant="danger" href="/services/hr">
                      Read More
                    </Button>
                  </div>
                </div>
                <div className="home-service-mobile">
                  ...
                  <div className="home-service-text-mobile">
                    ...
                    <h6 className="bukra-regular">
                      We are often engaged to provide Custom-tailored solutions
                      that meet the needs of your particular organization.
                    </h6>
                  </div>

                  <div style={{ textAlign: 'right', paddingTop: '20px' }}>
                    <Button variant="danger" href="/services/toolbox">
                      Read More
                    </Button>
                  </div>
                </div>
              ...
              <Grid item xs={6}>
                <div className="home-service-mobile">
                  ...
                  <div className="home-service-text-mobile">
                    ...
                    <h6 className="bukra-regular">
                      We act as your marketing arm department, dedicated to
                      achieve the goal at the highest quality, on time and
                      within your budget.
                    </h6>
                  </div>

                  <div style={{ textAlign: 'right', paddingTop: '20px' }}>
                    <Button variant="danger" href="/services/marketingMgmt">
                      Read More
                    </Button>
                  </div>
                </div>
                <div className="home-service-mobile">
                  ...
                  <div style={{ textAlign: 'right', paddingTop: '20px' }}>
                    <Button variant="danger" href="/services/financial">
                      Read More
                    </Button>
                  </div>
                </div>
              ...
              <div className="contact-left">
                <div className="contact-form-location-base-mobile">
                  <Map
                    ...
                    zoom={16}
                    className="contact-form-location-mobile"
                  >
                    <Marker
