            ...
            <div className='gallery-root'>
                ...
                <div className='gallery-body'>
                            ...
                            album.pictures.map((picture) => (
                                <Button variant='link' className='gallery-picture-base-mob' onClick={() => { window.location.href = picture.url }}>
                                    {picture.type === 'video' ?
                                        ...
                                        />
                                        :
                                        <img className='gallery-picture-mob' alt='placeholder' src={`${endpoint}/images/${picture.src}`} />
                                    }
                                </Button>
                            ))
                        ))}
                    ...
                    {/* {this.state.albumsPicked.length === 0 && this.state.albumsNotPicked.length === 0 ?
                        null
                        :
                        <div className='gallery-body-albums' style={{ backgroundImage: `url(${endpoint}/images/bg-four.png)`, backgroundSize: 'cover' }}>
                            <h4>Albums Picked</h4>
                            {this.state.albumsPicked.map((album) => (
