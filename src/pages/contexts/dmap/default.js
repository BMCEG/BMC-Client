      ...
      <Grid container className="banner-grid">
        <Grid item xs={6}>
          ...
          <h4>
            ...
            pharetra nibh. Morbi id urna hendrerit, placerat dui ut, convallis
            orci. Duis commodo nulla faucibus erat dictum, nec bibendum massa
            rutrum. Quisque ullamcorper tincidunt arcu, eget efficitur elit
            eleifend non. Duis id semper magna. Etiam pretium malesuada
