  ...
  render() {
    return (
      <div className="ewings-landing-root-mob">
        <Button
          className="ewings-course-fab-mob bukra-regular "
        ...
        <div className="ewings-landing-grid">
          <Typography
            ...
            variant="h3"
            component="h3"
            className="bukra-bold ewings-white-color course-header-mob"
          >
        ...
        <div className="training-desc-img-base-mob">
          <img
            className="training-desc-img-mob"
        ...
        <div className="training-desc-text-mob">
          <br></br>
          <h2 className="bukra-bold ewings-green-color ewings-subtitle-mob">
            Training Description
          </h2>
          <br></br>
          <h3 className="bukra-regular ewings-course-text-mob">
        ...
        <div className="landing-grid-div-outline-mob    ">
          ...
          <div className="landing-outline-grid-mob">
            ...
            <div className="training-desc-text">
              ...
              <br></br>
              <h3 className="bukra-regular ewings-course-text-outline-mob ewings-blue-color">
        ...
        <div className="training-methodology-img-base-mob">
          <img
            className="training-methodology-img-mob"
            src={`${endpoint}/images/${this.state.imageMethodologySrc}`}
            alt="sds"
          />
          <div className="training-methodology-text-mob">
            <h2 className="bukra-bold ewings-white-color ewings-subtitle-mob">
        ...
        <div className="landing-grid-div">
          <div className="course-meet-trainer">
            <h2 className="bukra-bold course-meet-trainer-title-mob">
              Meet the Trainer
            </h2>
            <br></br>
            <br></br>
            ...
            <br></br>
            <br></br>
            <h3 className="bukra-medium course-meet-trainer-title-mob">
        ...
        <div className="training-desc-text-mob">
          ...
          {this.state.courseSchedules.map((schedule, index) => (
            <div key={index} className="course-schedule-mob">
              ...
              <h4 className="bukra-regular ewings-course-text-mob">
              ...
              <br></br>
              <h3 className="bukra-medium ewings-course-text-mob">
                Start Date:
              </h3>
              <h4 className="bukra-regular ewings-course-text-mob">
                {' '}
                <Moment format="dddd, DD/MM/YYYY">{schedule.startDate}</Moment>
              </h4>
              <br></br>
              <h3 className="bukra-medium ewings-course-text-mob">End Date:</h3>
              <h4 className="bukra-regular ewings-course-text-mob">
                {' '}
                <Moment format="dddd, DD/MM/YYYY">{schedule.endDate}</Moment>
              </h4>
              <br></br>
              ...
              {schedule.dates.map((date, index) => (
                <div
                  key={index}
                  className="landing-mob-course-schedule-date-mob"
                >
              ...
              {index < this.state.courseSchedules.length ? <br></br> : null}
            </div>
          ))}
        </div>
