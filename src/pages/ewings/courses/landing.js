    ...
    return (
      <div className="ewings-landing-root">
        {this.state.isFabHover ? (
          <Button
            className="ewings-course-fab bukra-regular "
            onMouseLeave={this.handleFabHover}
            onMouseOver={this.handleFabHover}
        ...
        <div className="ewings-landing-grid ewings-height">
          <Typography
            ...
            variant="h3"
            component="h3"
            className="bukra-bold ewings-white-color course-header"
          >
          ...
          <div className="landing-grid-div">
            <div className="training-desc-img-base">
              <img
                className="training-desc-img"
                src={`${endpoint}/images/${this.state.imageDescriptionSrc}`}
                alt="Trainer Avatar"
              ></img>
            </div>
            <div className="training-desc-text">
              <h2 className="bukra-bold ewings-green-color ewings-subtitle">
                Training Description
              </h2>
              <br></br>
              <h3 className="bukra-regular ewings__home__banner__body">
        ...
        <div className="landing-grid-div-outline ewings-height">
          ...
          <div className="landing-outline-grid">
            <div className="training-desc-text">
              ...
              <br></br>
              <h3 className="bukra-regular ewings__home__banner__body ewings-blue-color">
        ...
        <div className="ewings-landing-grid">
          ...
          <div className="training-methodology-row">
            <div className="training-methodology-img-base">
              {this.state.courseDetails.title === 'graphic_design' ? (
                <>
                  <img
                    className="training-methodology-img"
                    src={`${endpoint}/images/${this.state.imageMethodologySrc}`}
                    alt="sds"
                  />
                  <img
                    className="training-methodology-img-mask"
                    src={`${endpoint}/images/22222.png`}
                    alt="sds"
                  />
                </>
              ) : (
            ...
            <div className="training-methodology-text">
              <h2 className="bukra-bold ewings-white-color ewings-subtitle">
                Training Methodology
              </h2>
              <br></br>
              <Typography
                style={{ color: 'white' }}
                className="bukra-regular ewings__home__banner__body"
              >
          ...
          <div className="landing-grid-div">
            <div className="course-meet-trainer">
              <h2 className="bukra-bold course-meet-trainer-title">
                Meet the Trainer
              </h2>
              <br></br>
              <br></br>
                ...
                <div key={index} className="course-schedule">
                  <div className="ewings-course-booking-text">
                    <h3 className="bukra-regular ewings-course-booking-info">
                      Fees:- {this.state.courseFees} EGP
                    </h3>
                    <h3 className="bukra-regular ewings-course-booking-info">
