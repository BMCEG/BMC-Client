        ...
        <div className="ewings-service-page-mob">
          ...
          <div className="ewings-service-page-content">
            {this.props.title === 'Digital Marketing' ? (
              <DigitalMob />
            ) : this.props.title === 'Multimedia Production' ? (
              <MultimediaMob />
            ) : this.props.title === 'Social Media Management' ? (
              <SocialMob />
            ) : this.props.title === 'Media Planning and Buying' ? (
              <MediaMob />
            ) : this.props.title === 'Web Development' ? (
              <WebMob />
            ) : null}
          </div>
        </div>
