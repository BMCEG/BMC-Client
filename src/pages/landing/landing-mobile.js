...
export default class Landing extends Component {
    ...
    render() {
        return (
            <div className="landing-mob-root" style={{ backgroundImage: `url(${endpoint}/images/bg-experts.png)`, backgroundSize: 'cover' }}>
                <div className="landing-mob-grid" style={{ backgroundImage: `url(${endpoint}/images/bg-founder.png)`, backgroundSize: 'cover' }}>
