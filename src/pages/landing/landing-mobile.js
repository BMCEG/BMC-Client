  ...
  render() {
    return (
      ...
      >
        ...
        >
          <Typography
            className="bukra-bold landing-mob-title"
            variant="h3"
            component="h3"
          >
          ...
          <div className="landing-grid-div">
            <div className="landing-grid-text">
              <h1
                ...
                style={{ textShadow: '2px 2px lightgrey' }}
              >
              ...
              <div className="landing-grid-btn-base">
                <Button
                  variant="danger"
                  className="landing-mob-grid-btn"
          ...
          <div className="landing-grid-div">
            <div className="landing-grid-text">
              ...
              <br></br>
              <h1 style={{ textAlign: 'center' }} className="bukra-bold">
              ...
              {this.state.courseSchedules.map((schedule, index) => (
                <div key={index} className="course-schedule">
                  ...
                  {schedule.dates.map((date, index) => (
                    <div
                      key={index}
                      className="landing-mob-course-schedule-date"
                    >
